module MediaResources
  module Filters
    module Helpers
      ...
      include MediaResources::Filters::MetaDataTypes
      include MediaResources::Filters::MetaKeys
      ...
      module ClassMethods
          ...
          if meta_datum[:not_key]
            ...
            filter_by_meta_key(meta_datum[:key], meta_datum[:md_alias])
              .filter_by_meta_datum_type \
                ::MetaData::FilterHelpers.with_type(meta_datum)
          end
        end
        ...
        def search_in_all_meta_data(match, meta_key_ids)
          ...
          where "id IN (#{subquery1} UNION #{subquery2} UNION #{subquery3})"
        end
      end
    end
  end
