class AddLocalizedHintsToContextKeys < ActiveRecord::Migration[4.2]
  ...
  def change
    ...
    reversible do |dir|
      add_column :context_keys, :hints, :hstore, default: {}, null: false

      MigrationContextKey.reset_column_information
      dir.up do
        ActiveRecord::Base.transaction do
          MigrationContextKey.find_each do |context_key|
            context_key.update_column(:hints, { default_locale => context_key.hint })
          end
        end
      end
    end
