class AddUserToMetaData < ActiveRecord::Migration
  def up
    ...
    add_index(:meta_data_people,
              [:meta_datum_id, :person_id, :created_by_id],
              name: :index_md_people_on_md_id_and_person_id_and_created_by_id,
              unique: true)
    ...
    add_index(:meta_data_groups,
              [:meta_datum_id, :group_id, :created_by_id],
              name: :index_md_groups_on_md_id_and_group_id_and_created_by_id,
              unique: true)
    ...
    add_index(:meta_data_licenses,
              [:meta_datum_id, :license_id, :created_by_id],
              name: :index_md_licenses_on_md_id_and_license_id_and_created_by_id,
              unique: true)
    ...
    add_index(:meta_data_users,
              [:meta_datum_id, :user_id, :created_by_id],
              name: :index_md_users_on_md_id_and_user_id_and_created_by_id,
              unique: true)
