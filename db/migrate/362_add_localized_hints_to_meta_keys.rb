class AddLocalizedHintsToMetaKeys < ActiveRecord::Migration[4.2]
  ...
  def change
    ...
    reversible do |dir|
      add_column :meta_keys, :hints, :hstore, default: {}, null: false
      ...
      dir.up do
        ...
        ActiveRecord::Base.transaction do
          MigrationMetaKey.find_each do |meta_key|
            meta_key.update_column(:hints, { default_locale => meta_key.hint })
          end
        end
