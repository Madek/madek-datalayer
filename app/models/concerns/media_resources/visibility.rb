    ...
    module Visibility
      ...
      module ClassMethods
        ...
        def viewable_by_workflow_creator(user)
          ...
          arel_table
            .project(1)
            .join(collection_media_entry_arcs).on(collection_media_entry_arcs[:media_entry_id].eq(arel_table[:id]))
            .join(collections).on(collections[:id].eq(collection_media_entry_arcs[:collection_id]))
